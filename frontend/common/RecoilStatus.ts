...
// 7. 지역 데이터를 저장할 atom 정의
export const areaState = atom({
  key: "areaState", // 유니크한 key
  default: [{ areaName: "", areaCd: "" }], // 초기값
});
// 8. 시,군,구 지역 정보를 저장할 atom 정의
export const areaInfoState = atom({
  key: "areaInfo", // 유니크한 key
  default: [{ areaInfo: "", areaInfoCd: "", areaCd: "" }], // 초기값
});
